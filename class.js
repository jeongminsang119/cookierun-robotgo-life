class Stage {
  ...
  init() {
    ...
    this.itemPosition = this.blastPosition.concat(
      this.coinMagicPosition,
      this.giantPosition,
      this.magnetPosition,
      this.energyPosition,
      this.miniEnergyPosition
    );
    this.callMap();
  }
  stageStart() {
  ...
  callMap() {
    ...
    this.jumpObstaclePosition.forEach((o) => {
      allObstacleComProp.arr.push(
        new Obstacle(o, 565.5, this.damage, this.jumpObstacle)
      );
    });
    this.doubleJumpObstaclePosition.forEach((o) => {
      allObstacleComProp.arr.push(
        new Obstacle(o, 377, this.damage, this.doubleJumpObstacle)
      );
    });
    this.slideObstaclePosition.forEach((o) => {
      allObstacleComProp.arr.push(
        new Obstacle(o, 0, this.damage, this.slideObstacle)
      );
    });
    ...
    for (let i = 0; i < (this.length - 500) / 100; i++) {
      ...
      if (
        ...
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 100, 169.65, "big_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 200, 169.65, "big_bear")
        );
        i += 2;
      } else if (
        this.jumpObstaclePosition.indexOf(jellyPosition + 100) !== -1
        ...
        allJellyComProp.arr.push(
          new Jelly(jellyPosition, 358.15, "yellow_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 100, 358.15, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 200, 358.15, "blue_bear")
        );
        i += 2;
      } else if (
        this.slideObstaclePosition.indexOf(jellyPosition + 100) !== -1
        ...
        allJellyComProp.arr.push(
          new Jelly(jellyPosition, 584.35, "yellow_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 100, 584.35, "yellow_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 200, 584.35, "yellow_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 300, 584.35, "yellow_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 400, 584.35, "yellow_bear")
        );
        i += 4;
      } else if (this.goodPatternPosition.indexOf(jellyPosition + 100) !== -1) {
        //GOOD 패턴
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 150, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 200, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 250, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 100, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 100, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 200, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 250, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 100, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 250, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 150, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 200, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 250, 600, "pink_bear")
        );

        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 400, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 450, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 350, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 500, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 350, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 500, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 350, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 500, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 400, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 450, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 650, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 700, 400, "pink_bear")
        );

        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 600, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 750, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 600, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 750, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 600, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 750, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 650, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 700, 600, "pink_bear")
        );

        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 850, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 900, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 950, 400, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 850, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 1000, 450, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 850, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 1000, 500, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 850, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 1000, 550, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 850, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 900, 600, "pink_bear")
        );
        allJellyComProp.arr.push(
          new Jelly(jellyPosition + 950, 600, "pink_bear")
        );
        ...
        for (let l = 0; l < 10; l++) {
          for (let k = 0; k < 4; k++) {
            allJellyComProp.arr.push(
              new Jelly(jellyPosition + 100 * l, 500 - 100 * k, "yellow_bear")
            );
          }
          i++;
        }
...
class Cookie {
  constructor(el) {
    ...
    this.hpValue = localStorage.getItem("hp")
  ...
  minusHp(hp) {
    const hpBox = document.querySelector(
  ...
  setScore() {
    if (!gameProp.paused) {
      ...
      if (this.type === "coin") {
        ...
        document.querySelector(".coin_amount").innerText =
          stageInfo.currentStage.totalCoin;
      }
    }
  }
}
...
class Obstacle {
  ...
  coinMagicObstacle() {
    for (
      let i = 0;
      i < (this.position().top - this.position().bottom) / 50;
      i++
    ) {
      for (
        let j = 0;
        j < (this.position().right - this.position().left) / 50;
        j++
      ) {
        allJellyComProp.arr.push(
          new Jelly(this.x + j * 50, this.y + i * 50 - 35, "coin")
        );
      }
    }
    this.el.remove();
...
class Item {
  ...
  coinMagic() {
    allObstacleComProp.arr.forEach((arr) => {
      if (
        arr.x < cookie.movex + (gameProp.screenWidth / 5) * 4 &&
        arr.x > cookie.movex - gameProp.screenWidth / 5
      ) {
